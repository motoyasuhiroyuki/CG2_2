...
metadata.format = MakeSRGB(metadata.format);
	...
	result = device->CreateCommittedResource(
		...
		D3D12_RESOURCE_STATE_GENERIC_READ,
		nullptr,IID_PPV_ARGS(&constBuffMaterial)
	...
	constMapTransform->mat.r[0].m128_f32 [0] = 2.0f/1280 ;// ウィンドウ横幅
	constMapTransform->mat.r[1].m128_f32 [1] =-2.0f/720 ;// ウィンドウ縦幅

	constMapTransform->mat.r[3].m128_f32 [0]=-0.0f;//  X座標
	constMapTransform->mat.r[3].m128_f32 [1]=0.0f;//   Y座標
	...
	rootParams[2].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL; // 全てのシェーダから見えるルートパラメータを変更する。!!
